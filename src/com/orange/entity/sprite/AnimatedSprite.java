...
public class AnimatedSprite extends TiledSprite {
	...
	public AnimatedSprite(final float pX, final float pY, final String pTextureRegionName, final VertexBufferObjectManager pVertexBufferObjectManager) {
		super(pX, pY, RegionRes.getRegion(pTextureRegionName), pVertexBufferObjectManager, DrawType.DYNAMIC);
	}
	...
	public AnimatedSprite(final float pX, final float pY, final float pWidth, final float pHeight, final String pTextureRegionName, final VertexBufferObjectManager pVertexBufferObjectManager) {
		super(pX, pY, pWidth, pHeight, RegionRes.getRegion(pTextureRegionName), pVertexBufferObjectManager, DrawType.DYNAMIC);
	}
