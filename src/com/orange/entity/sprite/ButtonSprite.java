...
/**
 * Note: {@link ButtonSprite} needs to be registered as a {@link ITouchArea} to the {@link BaseScene} via {@link BaseScene#registerTouchArea(ITouchArea)}, otherwise it won't be clickable.
 * To make {@link ButtonSprite} function properly, you should consider setting {@link BaseScene#setTouchAreaBindingOnActionDownEnabled(boolean)} to <code>true</code>.
 *
 * (c) OrangeGame 2012
 *
...
public class ButtonSprite extends TiledSprite {
	...
	public ButtonSprite(final float pX, final float pY, final  String pTextureRegionName, final VertexBufferObjectManager pVertexBufferObjectManager) {
	...
	public ButtonSprite(final float pX, final float pY, final  String pTextureRegionName, final VertexBufferObjectManager pVertexBufferObjectManager, final OnClickListener pOnClickListener) {
		this(pX, pY, RegionRes.getRegion(pTextureRegionName), pVertexBufferObjectManager, pOnClickListener);
	}
