...
import com.orange.entity.sprite.vbo.HighPerformanceSpriteVertexBufferObject;
import com.orange.entity.sprite.vbo.ISpriteVertexBufferObject;
...
public class Sprite extends RectangularShape {
	...
	public static final int SPRITE_SIZE = Sprite.VERTEX_SIZE
	...
	public Sprite(final float pX, final float pY, final float pWidth,
	...
	public void setFlipped(final boolean pFlippedHorizontal,
			final boolean pFlippedVertical) {
		if ((this.mFlippedHorizontal != pFlippedHorizontal)
				|| (this.mFlippedVertical != pFlippedVertical)) {
			this.mFlippedHorizontal = pFlippedHorizontal;
			this.mFlippedVertical = pFlippedVertical;
	...
	protected void draw(final GLState pGLState, final Camera pCamera) {
		this.mSpriteVertexBufferObject.draw(GLES20.GL_TRIANGLE_STRIP,
				Sprite.VERTICES_PER_SPRITE);
	}
