...
public class BitmapTextureAtlasTextureRegionFactory {
	...
	public static TextureRegion createFromFile(final BitmapTextureAtlas pBitmapTextureAtlas, final String pFilePath, final int pTexturePositionX, final int pTexturePositionY) {
		final IBitmapTextureAtlasSource bitmapTextureAtlasSource = FileBitmapTextureAtlasSource.create(new File(pFilePath));
	...
	public static TiledTextureRegion createTiledFromFile(final BitmapTextureAtlas pBitmapTextureAtlas, final String pFilePath, final int pTexturePositionX, final int pTexturePositionY, final int pTileColumns, final int pTileRows) {
		final IBitmapTextureAtlasSource bitmapTextureAtlasSource = FileBitmapTextureAtlasSource.create(new File(pFilePath));
	...
	public static TextureRegion createFromByte(final BitmapTextureAtlas pBitmapTextureAtlas, final byte[] pBytes, final int pTexturePositionX, final int pTexturePositionY) {
		final IBitmapTextureAtlasSource bitmapTextureAtlasSource = ByteBitmapTextureAtlasSource.create(pBytes);
		return BitmapTextureAtlasTextureRegionFactory.createFromSource(pBitmapTextureAtlas, bitmapTextureAtlasSource, pTexturePositionX, pTexturePositionY);
	}

	public static TiledTextureRegion createTiledFromByte(final BitmapTextureAtlas pBitmapTextureAtlas, final byte[] pBytes, final int pTexturePositionX, final int pTexturePositionY, final int pTileColumns, final int pTileRows) {
		final IBitmapTextureAtlasSource bitmapTextureAtlasSource = ByteBitmapTextureAtlasSource.create(pBytes);
		return BitmapTextureAtlasTextureRegionFactory.createTiledFromSource(pBitmapTextureAtlas, bitmapTextureAtlasSource, pTexturePositionX, pTexturePositionY, pTileColumns, pTileRows);
	}
	...
	public static TextureRegion createFromFile(final BuildableBitmapTextureAtlas pBuildableBitmapTextureAtlas, final String pFilePath) {
		final IBitmapTextureAtlasSource bitmapTextureAtlasSource = FileBitmapTextureAtlasSource.create(new File(pFilePath));
		return BitmapTextureAtlasTextureRegionFactory.createFromSource(pBuildableBitmapTextureAtlas, bitmapTextureAtlasSource);
	}

	public static TiledTextureRegion createTiledFromFile(final BuildableBitmapTextureAtlas pBuildableBitmapTextureAtlas, final String pFilePath, final int pTexturePositionX, final int pTexturePositionY, final int pTileColumns, final int pTileRows) {
		final IBitmapTextureAtlasSource bitmapTextureAtlasSource = FileBitmapTextureAtlasSource.create(new File(pFilePath));
	...
	public static TextureRegion createFromByte(final BuildableBitmapTextureAtlas pBuildableBitmapTextureAtlas, final byte[] pBytes) {
		final IBitmapTextureAtlasSource bitmapTextureAtlasSource = ByteBitmapTextureAtlasSource.create(pBytes);
		return BitmapTextureAtlasTextureRegionFactory.createFromSource(pBuildableBitmapTextureAtlas, bitmapTextureAtlasSource);
	}

	public static TiledTextureRegion createTiledFromFile(final BuildableBitmapTextureAtlas pBuildableBitmapTextureAtlas, final byte[] pBytes, final int pTexturePositionX, final int pTexturePositionY, final int pTileColumns, final int pTileRows) {
		final IBitmapTextureAtlasSource bitmapTextureAtlasSource = ByteBitmapTextureAtlasSource.create(pBytes);
		return BitmapTextureAtlasTextureRegionFactory.createTiledFromSource(pBuildableBitmapTextureAtlas, bitmapTextureAtlasSource, pTileColumns, pTileRows);
	}
