...
import com.orange.util.progress.IProgressListener;
...
public abstract class SimpleAsyncGameActivity extends BaseGameActivity {
	...
	public abstract SceneGroup onCreateSceneGroupAsync(final IProgressListener pProgressListener) throws Exception; // TODO Rename
	public abstract void onPopulateSceneAsync(final SceneGroup pSceneGroup, IProgressListener pProgressListener) throws Exception; // TODO Rename
		...
		this.runOnUiThread(new Runnable() {
			...
			public void run() {
				ActivityUtils.doProgressAsync(SimpleAsyncGameActivity.this, "Loading Scene...", android.R.drawable.ic_menu_rotate, new ProgressCallable<Void>() {
					@Override
					public Void call(final IProgressListener pProgressListener) throws Exception {
						final SceneGroup sceneGroup = SimpleAsyncGameActivity.this.onCreateSceneGroupAsync(pProgressListener);
	...
	@Override
	public void onPopulateScene(final SceneGroup pSceneGroup, final OnPopulateSceneCallback pOnPopulateSceneCallback) {
		this.runOnUiThread(new Runnable() {
			@Override
			public void run() {
				ActivityUtils.doProgressAsync(SimpleAsyncGameActivity.this, "Populating Scene...", android.R.drawable.ic_menu_rotate, new ProgressCallable<Void>() {
					@Override
					public Void call(final IProgressListener pProgressListener) throws Exception {
						SimpleAsyncGameActivity.this.onPopulateSceneAsync(pSceneGroup, pProgressListener);
