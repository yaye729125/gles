...
public abstract class GameActivity extends BaseGameActivity implements ISceneLauncher {
	...
	protected void onSetContentView() {
		...
		ViewGroup.LayoutParams renderLayout_params = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
		this.mRenderLayout = new FrameLayout(this);
		this.mRenderLayout.setLayoutParams(renderLayout_params);

		// EditText layout
		ViewGroup.LayoutParams editTextLayout_params = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
		EditText editText = new EditText(this);
		editText.setLayoutParams(editTextLayout_params);

		ViewGroup.LayoutParams renderSurfaceView_params = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
	...
	public Scene startSceneForResult(Class<? extends Scene> pSceneCls, SceneBundle bundle, int requestCode) {
		...
		Object[] argParam = { this, this, this.getEngine(), bundle, requestCode };
	...
	public void finishScene(Scene pScene) {
		int sceneCount = this.mSceneGroup.getScenerCount();
		if (sceneCount > 1) {
			this.mSceneGroup.detachScene(pScene);
