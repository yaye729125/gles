...
public class Debug {
	...
	public static String sTag = Constants.DEBUGTAG;
	...
	public static void d(final Object pClass, String pMessage) {
		Debug.d(Debug.sTag, pClass.getClass().getSimpleName() + "", null);
		Debug.d(Debug.sTag, pMessage + "", null);
	}
	
	public static void d(final Object pMessage) {
		Debug.d(Debug.sTag, pMessage + "", null);
	}
