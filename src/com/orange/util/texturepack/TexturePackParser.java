...
import com.orange.opengl.texture.compressed.etc1.ETC1Texture;
import com.orange.opengl.texture.compressed.pvr.PVRCCZTexture;
import com.orange.opengl.texture.compressed.pvr.PVRGZTexture;
import com.orange.opengl.texture.compressed.pvr.PVRTexture;
import com.orange.opengl.texture.compressed.pvr.PVRTexture.PVRTextureFormat;
import com.orange.opengl.texture.compressed.pvr.pixelbufferstrategy.SmartPVRTexturePixelBufferStrategy;
...
public class TexturePackParser extends DefaultHandler {
	...
	public void startElement(final String pUri, final String pLocalName, final String pQualifiedName, final Attributes pAttributes) throws SAXException {
		if(pLocalName.equals(TexturePackParser.TAG_TEXTURE)) {
			...
			this.mTextureRegionLibrary = new TexturePackTextureRegionLibrary(this.mTexture, 10);
	...
	private ITexture parseTexture(final Attributes pAttributes) throws TexturePackParseException {
		...
		final int textureWidth = SAXUtils.getIntAttributeOrThrow(pAttributes, TexturePackParser.TAG_TEXTURE_ATTRIBUTE_WIDTH);
		final int textureHeight = SAXUtils.getIntAttributeOrThrow(pAttributes, TexturePackParser.TAG_TEXTURE_ATTRIBUTE_HEIGHT);
		...
		if(type.equals(TexturePackParser.TAG_TEXTURE_ATTRIBUTE_TYPE_VALUE_BITMAP)) {
			try {
				...
				}, BitmapTextureFormat.fromPixelFormat(pixelFormat), textureOptions, textureWidth, textureHeight);
			...
			try {
				texture = new ETC1Texture(this.mTextureManager, textureOptions) {
